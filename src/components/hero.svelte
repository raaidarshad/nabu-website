<main>
    <div id="my-hero">
        ...
        <div id="hero-sub-text">
            ...
            <a id='firefox-cta' href='https://addons.mozilla.org/en-US/firefox/addon/nabu/'><p><img src=".vercel_build_output/static/ff-logo.png" alt="Firefox extension">Firefox</p></a>
